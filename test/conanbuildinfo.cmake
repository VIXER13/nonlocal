...
###  SPECTRA
#################
set(CONAN_SPECTRA_ROOT "/home/vixer/.conan/data/spectra/1.0.1/_/_/package/5ab84d6acfe1f23c4fae0ab88f26e3a396351ac9")
set(CONAN_INCLUDE_DIRS_SPECTRA "/home/vixer/.conan/data/spectra/1.0.1/_/_/package/5ab84d6acfe1f23c4fae0ab88f26e3a396351ac9/include")
set(CONAN_LIB_DIRS_SPECTRA )
set(CONAN_BIN_DIRS_SPECTRA )
set(CONAN_RES_DIRS_SPECTRA )
set(CONAN_SRC_DIRS_SPECTRA )
set(CONAN_BUILD_DIRS_SPECTRA "/home/vixer/.conan/data/spectra/1.0.1/_/_/package/5ab84d6acfe1f23c4fae0ab88f26e3a396351ac9/")
set(CONAN_FRAMEWORK_DIRS_SPECTRA )
set(CONAN_LIBS_SPECTRA )
set(CONAN_PKG_LIBS_SPECTRA )
set(CONAN_SYSTEM_LIBS_SPECTRA m)
set(CONAN_FRAMEWORKS_SPECTRA )
set(CONAN_FRAMEWORKS_FOUND_SPECTRA "")  # Will be filled later
set(CONAN_DEFINES_SPECTRA )
set(CONAN_BUILD_MODULES_PATHS_SPECTRA )
# COMPILE_DEFINITIONS are equal to CONAN_DEFINES without -D, for targets
set(CONAN_COMPILE_DEFINITIONS_SPECTRA )

set(CONAN_C_FLAGS_SPECTRA "")
set(CONAN_CXX_FLAGS_SPECTRA "")
set(CONAN_SHARED_LINKER_FLAGS_SPECTRA "")
set(CONAN_EXE_LINKER_FLAGS_SPECTRA "")

# For modern cmake targets we use the list variables (separated with ;)
set(CONAN_C_FLAGS_SPECTRA_LIST "")
set(CONAN_CXX_FLAGS_SPECTRA_LIST "")
set(CONAN_SHARED_LINKER_FLAGS_SPECTRA_LIST "")
set(CONAN_EXE_LINKER_FLAGS_SPECTRA_LIST "")

# Apple Frameworks
conan_find_apple_frameworks(CONAN_FRAMEWORKS_FOUND_SPECTRA "${CONAN_FRAMEWORKS_SPECTRA}" "_SPECTRA" "")
# Append to aggregated values variable
set(CONAN_LIBS_SPECTRA ${CONAN_PKG_LIBS_SPECTRA} ${CONAN_SYSTEM_LIBS_SPECTRA} ${CONAN_FRAMEWORKS_FOUND_SPECTRA})


#################
###  NLOHMANN_JSON
#################
set(CONAN_NLOHMANN_JSON_ROOT "/home/vixer/.conan/data/nlohmann_json/3.11.2/_/_/package/5ab84d6acfe1f23c4fae0ab88f26e3a396351ac9")
set(CONAN_INCLUDE_DIRS_NLOHMANN_JSON "/home/vixer/.conan/data/nlohmann_json/3.11.2/_/_/package/5ab84d6acfe1f23c4fae0ab88f26e3a396351ac9/include")
...
set(CONAN_BUILD_DIRS_NLOHMANN_JSON "/home/vixer/.conan/data/nlohmann_json/3.11.2/_/_/package/5ab84d6acfe1f23c4fae0ab88f26e3a396351ac9/")
...
###  BOOST-EXT-UT
#################
set(CONAN_BOOST-EXT-UT_ROOT "/home/vixer/.conan/data/boost-ext-ut/1.1.9/_/_/package/5ab84d6acfe1f23c4fae0ab88f26e3a396351ac9")
set(CONAN_INCLUDE_DIRS_BOOST-EXT-UT "/home/vixer/.conan/data/boost-ext-ut/1.1.9/_/_/package/5ab84d6acfe1f23c4fae0ab88f26e3a396351ac9/include/ut-1.1.9/include")
...
set(CONAN_BUILD_DIRS_BOOST-EXT-UT )
...
###  EIGEN
#################
set(CONAN_EIGEN_ROOT "/home/vixer/.conan/data/eigen/3.4.0/_/_/package/5ab84d6acfe1f23c4fae0ab88f26e3a396351ac9")
set(CONAN_INCLUDE_DIRS_EIGEN "/home/vixer/.conan/data/eigen/3.4.0/_/_/package/5ab84d6acfe1f23c4fae0ab88f26e3a396351ac9/include/eigen3")
...
set(CONAN_DEPENDENCIES spectra nlohmann_json boost-ext-ut eigen)
...
set(CONAN_INCLUDE_DIRS "/home/vixer/.conan/data/spectra/1.0.1/_/_/package/5ab84d6acfe1f23c4fae0ab88f26e3a396351ac9/include"
			"/home/vixer/.conan/data/nlohmann_json/3.11.2/_/_/package/5ab84d6acfe1f23c4fae0ab88f26e3a396351ac9/include"
			"/home/vixer/.conan/data/boost-ext-ut/1.1.9/_/_/package/5ab84d6acfe1f23c4fae0ab88f26e3a396351ac9/include/ut-1.1.9/include"
			"/home/vixer/.conan/data/eigen/3.4.0/_/_/package/5ab84d6acfe1f23c4fae0ab88f26e3a396351ac9/include/eigen3" ${CONAN_INCLUDE_DIRS})
...
set(CONAN_CMAKE_MODULE_PATH "/home/vixer/.conan/data/spectra/1.0.1/_/_/package/5ab84d6acfe1f23c4fae0ab88f26e3a396351ac9/"
			"/home/vixer/.conan/data/nlohmann_json/3.11.2/_/_/package/5ab84d6acfe1f23c4fae0ab88f26e3a396351ac9/" ${CONAN_CMAKE_MODULE_PATH})
...
macro(conan_define_targets)
    ...
    set(_CONAN_PKG_LIBS_SPECTRA_DEPENDENCIES "${CONAN_SYSTEM_LIBS_SPECTRA} ${CONAN_FRAMEWORKS_FOUND_SPECTRA} CONAN_PKG::eigen")
    string(REPLACE " " ";" _CONAN_PKG_LIBS_SPECTRA_DEPENDENCIES "${_CONAN_PKG_LIBS_SPECTRA_DEPENDENCIES}")
    conan_package_library_targets("${CONAN_PKG_LIBS_SPECTRA}" "${CONAN_LIB_DIRS_SPECTRA}"
                                  CONAN_PACKAGE_TARGETS_SPECTRA "${_CONAN_PKG_LIBS_SPECTRA_DEPENDENCIES}"
                                  "" spectra)
    set(_CONAN_PKG_LIBS_SPECTRA_DEPENDENCIES_DEBUG "${CONAN_SYSTEM_LIBS_SPECTRA_DEBUG} ${CONAN_FRAMEWORKS_FOUND_SPECTRA_DEBUG} CONAN_PKG::eigen")
    string(REPLACE " " ";" _CONAN_PKG_LIBS_SPECTRA_DEPENDENCIES_DEBUG "${_CONAN_PKG_LIBS_SPECTRA_DEPENDENCIES_DEBUG}")
    conan_package_library_targets("${CONAN_PKG_LIBS_SPECTRA_DEBUG}" "${CONAN_LIB_DIRS_SPECTRA_DEBUG}"
                                  CONAN_PACKAGE_TARGETS_SPECTRA_DEBUG "${_CONAN_PKG_LIBS_SPECTRA_DEPENDENCIES_DEBUG}"
                                  "debug" spectra)
    set(_CONAN_PKG_LIBS_SPECTRA_DEPENDENCIES_RELEASE "${CONAN_SYSTEM_LIBS_SPECTRA_RELEASE} ${CONAN_FRAMEWORKS_FOUND_SPECTRA_RELEASE} CONAN_PKG::eigen")
    string(REPLACE " " ";" _CONAN_PKG_LIBS_SPECTRA_DEPENDENCIES_RELEASE "${_CONAN_PKG_LIBS_SPECTRA_DEPENDENCIES_RELEASE}")
    conan_package_library_targets("${CONAN_PKG_LIBS_SPECTRA_RELEASE}" "${CONAN_LIB_DIRS_SPECTRA_RELEASE}"
                                  CONAN_PACKAGE_TARGETS_SPECTRA_RELEASE "${_CONAN_PKG_LIBS_SPECTRA_DEPENDENCIES_RELEASE}"
                                  "release" spectra)
    set(_CONAN_PKG_LIBS_SPECTRA_DEPENDENCIES_RELWITHDEBINFO "${CONAN_SYSTEM_LIBS_SPECTRA_RELWITHDEBINFO} ${CONAN_FRAMEWORKS_FOUND_SPECTRA_RELWITHDEBINFO} CONAN_PKG::eigen")
    string(REPLACE " " ";" _CONAN_PKG_LIBS_SPECTRA_DEPENDENCIES_RELWITHDEBINFO "${_CONAN_PKG_LIBS_SPECTRA_DEPENDENCIES_RELWITHDEBINFO}")
    conan_package_library_targets("${CONAN_PKG_LIBS_SPECTRA_RELWITHDEBINFO}" "${CONAN_LIB_DIRS_SPECTRA_RELWITHDEBINFO}"
                                  CONAN_PACKAGE_TARGETS_SPECTRA_RELWITHDEBINFO "${_CONAN_PKG_LIBS_SPECTRA_DEPENDENCIES_RELWITHDEBINFO}"
                                  "relwithdebinfo" spectra)
    set(_CONAN_PKG_LIBS_SPECTRA_DEPENDENCIES_MINSIZEREL "${CONAN_SYSTEM_LIBS_SPECTRA_MINSIZEREL} ${CONAN_FRAMEWORKS_FOUND_SPECTRA_MINSIZEREL} CONAN_PKG::eigen")
    string(REPLACE " " ";" _CONAN_PKG_LIBS_SPECTRA_DEPENDENCIES_MINSIZEREL "${_CONAN_PKG_LIBS_SPECTRA_DEPENDENCIES_MINSIZEREL}")
    conan_package_library_targets("${CONAN_PKG_LIBS_SPECTRA_MINSIZEREL}" "${CONAN_LIB_DIRS_SPECTRA_MINSIZEREL}"
                                  CONAN_PACKAGE_TARGETS_SPECTRA_MINSIZEREL "${_CONAN_PKG_LIBS_SPECTRA_DEPENDENCIES_MINSIZEREL}"
                                  "minsizerel" spectra)

    add_library(CONAN_PKG::spectra INTERFACE IMPORTED)

    # Property INTERFACE_LINK_FLAGS do not work, necessary to add to INTERFACE_LINK_LIBRARIES
    set_property(TARGET CONAN_PKG::spectra PROPERTY INTERFACE_LINK_LIBRARIES ${CONAN_PACKAGE_TARGETS_SPECTRA} ${_CONAN_PKG_LIBS_SPECTRA_DEPENDENCIES}
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,SHARED_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_SPECTRA_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,MODULE_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_SPECTRA_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,EXECUTABLE>:${CONAN_EXE_LINKER_FLAGS_SPECTRA_LIST}>

                                                                 $<$<CONFIG:Release>:${CONAN_PACKAGE_TARGETS_SPECTRA_RELEASE} ${_CONAN_PKG_LIBS_SPECTRA_DEPENDENCIES_RELEASE}
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,SHARED_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_SPECTRA_RELEASE_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,MODULE_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_SPECTRA_RELEASE_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,EXECUTABLE>:${CONAN_EXE_LINKER_FLAGS_SPECTRA_RELEASE_LIST}>>

                                                                 $<$<CONFIG:RelWithDebInfo>:${CONAN_PACKAGE_TARGETS_SPECTRA_RELWITHDEBINFO} ${_CONAN_PKG_LIBS_SPECTRA_DEPENDENCIES_RELWITHDEBINFO}
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,SHARED_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_SPECTRA_RELWITHDEBINFO_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,MODULE_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_SPECTRA_RELWITHDEBINFO_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,EXECUTABLE>:${CONAN_EXE_LINKER_FLAGS_SPECTRA_RELWITHDEBINFO_LIST}>>

                                                                 $<$<CONFIG:MinSizeRel>:${CONAN_PACKAGE_TARGETS_SPECTRA_MINSIZEREL} ${_CONAN_PKG_LIBS_SPECTRA_DEPENDENCIES_MINSIZEREL}
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,SHARED_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_SPECTRA_MINSIZEREL_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,MODULE_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_SPECTRA_MINSIZEREL_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,EXECUTABLE>:${CONAN_EXE_LINKER_FLAGS_SPECTRA_MINSIZEREL_LIST}>>

                                                                 $<$<CONFIG:Debug>:${CONAN_PACKAGE_TARGETS_SPECTRA_DEBUG} ${_CONAN_PKG_LIBS_SPECTRA_DEPENDENCIES_DEBUG}
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,SHARED_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_SPECTRA_DEBUG_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,MODULE_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_SPECTRA_DEBUG_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,EXECUTABLE>:${CONAN_EXE_LINKER_FLAGS_SPECTRA_DEBUG_LIST}>>)
    set_property(TARGET CONAN_PKG::spectra PROPERTY INTERFACE_INCLUDE_DIRECTORIES ${CONAN_INCLUDE_DIRS_SPECTRA}
                                                                      $<$<CONFIG:Release>:${CONAN_INCLUDE_DIRS_SPECTRA_RELEASE}>
                                                                      $<$<CONFIG:RelWithDebInfo>:${CONAN_INCLUDE_DIRS_SPECTRA_RELWITHDEBINFO}>
                                                                      $<$<CONFIG:MinSizeRel>:${CONAN_INCLUDE_DIRS_SPECTRA_MINSIZEREL}>
                                                                      $<$<CONFIG:Debug>:${CONAN_INCLUDE_DIRS_SPECTRA_DEBUG}>)
    set_property(TARGET CONAN_PKG::spectra PROPERTY INTERFACE_COMPILE_DEFINITIONS ${CONAN_COMPILE_DEFINITIONS_SPECTRA}
                                                                      $<$<CONFIG:Release>:${CONAN_COMPILE_DEFINITIONS_SPECTRA_RELEASE}>
                                                                      $<$<CONFIG:RelWithDebInfo>:${CONAN_COMPILE_DEFINITIONS_SPECTRA_RELWITHDEBINFO}>
                                                                      $<$<CONFIG:MinSizeRel>:${CONAN_COMPILE_DEFINITIONS_SPECTRA_MINSIZEREL}>
                                                                      $<$<CONFIG:Debug>:${CONAN_COMPILE_DEFINITIONS_SPECTRA_DEBUG}>)
    set_property(TARGET CONAN_PKG::spectra PROPERTY INTERFACE_COMPILE_OPTIONS ${CONAN_C_FLAGS_SPECTRA_LIST} ${CONAN_CXX_FLAGS_SPECTRA_LIST}
                                                                  $<$<CONFIG:Release>:${CONAN_C_FLAGS_SPECTRA_RELEASE_LIST} ${CONAN_CXX_FLAGS_SPECTRA_RELEASE_LIST}>
                                                                  $<$<CONFIG:RelWithDebInfo>:${CONAN_C_FLAGS_SPECTRA_RELWITHDEBINFO_LIST} ${CONAN_CXX_FLAGS_SPECTRA_RELWITHDEBINFO_LIST}>
                                                                  $<$<CONFIG:MinSizeRel>:${CONAN_C_FLAGS_SPECTRA_MINSIZEREL_LIST} ${CONAN_CXX_FLAGS_SPECTRA_MINSIZEREL_LIST}>
                                                                  $<$<CONFIG:Debug>:${CONAN_C_FLAGS_SPECTRA_DEBUG_LIST}  ${CONAN_CXX_FLAGS_SPECTRA_DEBUG_LIST}>)
    ...
    set(CONAN_TARGETS CONAN_PKG::spectra CONAN_PKG::nlohmann_json CONAN_PKG::boost-ext-ut CONAN_PKG::eigen)
