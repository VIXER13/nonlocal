...
class unrelated_rows final {
    template<class T>
    static bool has_related_rows(const Eigen::SparseMatrix<T, Eigen::RowMajor, I>& matrix, const std::vector<bool>& is_related,
...
bool unrelated_rows<I>::has_related_rows(const Eigen::SparseMatrix<T, Eigen::RowMajor, I>& matrix,
                                         const std::vector<bool>& is_related, const std::ranges::iota_view<I, I> indices) {
