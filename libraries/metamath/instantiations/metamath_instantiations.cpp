...
template sparse_matrix<double, uint32_t, size_t>& operator+=(sparse_matrix<double, uint32_t, size_t>&,
                                                             const sparse_matrix<double, uint32_t, size_t>&);

template struct sparse_matrix<square_matrix<double, 2>, uint32_t, size_t>;
template sparse_matrix<square_matrix<double, 2>, uint32_t, size_t>& operator*=(
    sparse_matrix<square_matrix<double, 2>, uint32_t, size_t>&, double);
template sparse_matrix<square_matrix<double, 2>, uint32_t, size_t>& operator/=(
    sparse_matrix<square_matrix<double, 2>, uint32_t, size_t>&, double);
template std::vector<std::array<double, 2>> operator*(const sparse_matrix<square_matrix<double, 2>, uint32_t, size_t>&,
