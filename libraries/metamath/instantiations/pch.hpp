...
extern template sparse_matrix<double, uint32_t, size_t>& operator+=(sparse_matrix<double, uint32_t, size_t>&,
                                                                    const sparse_matrix<double, uint32_t, size_t>&);

extern template struct sparse_matrix<square_matrix<double, 2>, uint32_t, size_t>;
extern template sparse_matrix<square_matrix<double, 2>, uint32_t, size_t>& operator*=(
    sparse_matrix<square_matrix<double, 2>, uint32_t, size_t>&, double);
extern template sparse_matrix<square_matrix<double, 2>, uint32_t, size_t>& operator/=(
    sparse_matrix<square_matrix<double, 2>, uint32_t, size_t>&, double);
extern template std::vector<std::array<double, 2>> operator*(const sparse_matrix<square_matrix<double, 2>, uint32_t, size_t>&,
                                                             const std::vector<std::array<double, 2>>&);
extern template sparse_matrix<square_matrix<double, 2>, uint32_t, size_t>& operator+=(
    sparse_matrix<square_matrix<double, 2>, uint32_t, size_t>&, const sparse_matrix<square_matrix<double, 2>, uint32_t, size_t>&);
} // namespace metamath::linear
