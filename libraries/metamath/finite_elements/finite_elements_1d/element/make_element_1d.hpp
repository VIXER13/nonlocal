...
std::unique_ptr<element_1d_base<T>> make_element_1d(const size_t order) {
    switch (order) {
    case 1:
        return make_element_1d<T, 1>();
    case 2:
        return make_element_1d<T, 2>();
    case 3:
        return make_element_1d<T, 3>();
    case 4:
        return make_element_1d<T, 4>();
    case 5:
        return make_element_1d<T, 5>();
    default:
        throw std::domain_error{ "Unsupported element order " + std::to_string(order) };
    }
}
