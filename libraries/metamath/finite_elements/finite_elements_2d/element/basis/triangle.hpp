...
class triangle<T, 1> : public barycentric<T> {
  protected:
    ...
    /*
        ...
        2--0
    */
    static inline constexpr std::array<std::array<T, 2>, 3> nodes = { T{ 1 }, T{ 0 }, //
                                                                      T{ 0 }, T{ 1 }, //
                                                                      T{ 0 }, T{ 0 } };
...
class triangle<T, 2> : public barycentric<T> {
  ...
  protected:
    ...
    /*
        ...
        2--5--0
    */
    static inline constexpr std::array<std::array<T, 2>, 6> nodes = { T{ 1.0 }, T{ 0.0 }, //
                                                                      T{ 0.0 }, T{ 1.0 }, //
                                                                      T{ 0.0 }, T{ 0.0 }, //
                                                                      T{ 0.5 }, T{ 0.5 }, //
                                                                      T{ 0.0 }, T{ 0.5 }, //
    ...
    static inline constexpr auto basis = std::make_tuple(L1 * (_2 * L1 - _1), //
                                                         L2*(_2* L2 - _1),    //
                                                         L3*(_2* L3 - _1),    //
                                                         _4 * L1 * L2,        //
                                                         _4 * L2 * L3,        //
...
class triangle<T, 3> : public barycentric<T> {
  ...
  protected:
    ...
    /*
        ...
        2-7-8-0
    */
    static inline constexpr std::array<std::array<T, 2>, 10> nodes = { T{ 1 },          T{ 0 },          //
                                                                       T{ 0 },          T{ 1 },          //
                                                                       T{ 0 },          T{ 0 },          //
                                                                       T{ 2 } / T{ 3 }, T{ 1 } / T{ 3 }, //
                                                                       T{ 1 } / T{ 3 }, T{ 2 } / T{ 3 }, //
    ...
    static inline constexpr auto basis = std::make_tuple(L1 * (_3 * L1 - _1) * (_3 * L1 - _2) / _2, //
