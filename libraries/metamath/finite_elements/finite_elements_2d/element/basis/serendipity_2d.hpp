...
class serendipity<T, 1> : public geometry_2d<T, rectangle_element_geometry> {
  ...
  protected:
    ...
    /*
        ...
        0---1
    */
    static inline constexpr std::array<std::array<T, 2>, 4> nodes = { T{ -1 }, T{ -1 }, //
                                                                      T{ 1 },  T{ -1 }, //
                                                                      T{ 1 },  T{ 1 },  //
                                                                      T{ -1 }, T{ 1 } };

    static inline constexpr auto basis = std::make_tuple((_1 - x) * (_1 - y) / _4, //
                                                         (_1 + x) * (_1 - y) / _4, //
                                                         (_1 + x) * (_1 + y) / _4, //
                                                         (_1 - x) * (_1 + y) / _4);
...
class serendipity<T, 2> : public serendipity_base<T> {
  ...
  protected:
    ...
    /*
        ...
        0---1---2
    */
    static inline constexpr std::array<std::array<T, 2>, 8> nodes = { T{ -1 }, T{ -1 }, //
                                                                      T{ 0 },  T{ -1 }, //
                                                                      T{ 1 },  T{ -1 }, //
                                                                      T{ 1 },  T{ 0 },  //
                                                                      T{ 1 },  T{ 1 },  //
...
class serendipity<T, 4> : public geometry_2d<T, rectangle_element_geometry> {
  ...
  protected:
    ...
    /*
        ...
        0---1---2---3--4
    */
    static inline constexpr std::array<std::array<T, 2>, 16> nodes = { T{ -1.0 }, T{ -1.0 }, //
                                                                       T{ -0.5 }, T{ -1.0 }, //
                                                                       T{ 0.0 },  T{ -1.0 }, //
                                                                       T{ 0.5 },  T{ -1.0 }, //
                                                                       T{ 1.0 },  T{ -1.0 }, //
...
class serendipity<T, 5> : public geometry_2d<T, rectangle_element_geometry> {
  ...
  protected:
    ...
    /*
        ...
        0---1---2---3---4---5
    */
    static inline constexpr std::array<std::array<T, 2>, 20> nodes = { T{ -1.0 }, T{ -1.0 }, //
                                                                       T{ -0.6 }, T{ -1.0 }, //
                                                                       T{ -0.2 }, T{ -1.0 }, //
                                                                       T{ 0.2 },  T{ -1.0 }, //
                                                                       T{ 0.6 },  T{ -1.0 }, //
