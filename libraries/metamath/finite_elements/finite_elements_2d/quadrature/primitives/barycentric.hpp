...
class barycentric_quadrature<T, 3> : public geometry_2d<T, triangle_element_geometry> {
  protected:
    static inline constexpr std::array<std::array<T, 2>, 4> nodes = { T{ 1 } / T{ 3 }, T{ 1 } / T{ 3 }, //
                                                                      ...
                                                                      T{ 0.2 },        T{ 0.6 },        //
                                                                      T{ 0.2 },        T{ 0.2 } };
    static inline constexpr std::array<T, 4> weights = { -T{ 27 } / T{ 96 }, //
                                                         T{ 25 } / T{ 96 },  //
                                                         T{ 25 } / T{ 96 },  //
                                                         T{ 25 } / T{ 96 } };
...
class barycentric_quadrature<T, 4> : public geometry_2d<T, triangle_element_geometry> {
  protected:
    ...
    static inline constexpr std::array<T, 6> weights = { T{ 0.11169079483900575 }, T{ 0.11169079483900575 },
                                                         T{ 0.11169079483900575 }, T{ 0.0549758718276611 },
                                                         T{ 0.0549758718276611 },  T{ 0.0549758718276611 } };
