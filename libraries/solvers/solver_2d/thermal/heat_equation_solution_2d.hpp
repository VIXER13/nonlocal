...
class heat_equation_solution_2d : public solution_2d<T, I> {
    ...
    parameters_2d<T> _parameters;

    void flux_from_gradient(std::array<std::vector<T>, 2>& gradient, const parameters_2d<T>& parameters, const T model_weight) const;
...
public:
    ...
    const parameters_2d<T>& parameters() const;
...
template<class T, class I>
const parameters_2d<T>& heat_equation_solution_2d<T, I>::parameters() const {
    return _parameters;
}
...
template<class T, class I>
void heat_equation_solution_2d<T, I>::flux_from_gradient(std::array<std::vector<T>, 2>& gradient, const parameters_2d<T>& parameters, const T model_weight) const {
