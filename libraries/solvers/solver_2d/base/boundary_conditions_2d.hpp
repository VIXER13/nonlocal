...
template<class T>
class first_kind_2d : public virtual boundary_condition_2d {
protected:
...
template<class T>
class second_kind_2d : public virtual boundary_condition_2d {
protected:
...
using boundary_conditions_2d = std::array<std::unique_ptr<boundary_condition_2d<T>>, DoF>;

template<class T, size_t DoF>
using boundary_conditions_map_2d = std::unordered_map<std::string, boundary_conditions_2d<T, DoF>>;
