...
class matrix_index_initializer final : public matrix_separator_base<T, I>
...
public:
    explicit matrix_index_initializer(finite_element_matrix<T, I>& matrix, const mesh::mesh_container_2d<T, I>& mesh, 
...
template<class T, class I, size_t DoF>
matrix_index_initializer<T, I, DoF>::matrix_index_initializer(finite_element_matrix<T, I>& matrix, const mesh::mesh_container_2d<T, I>& mesh, 
                                                const std::vector<bool>& is_inner, const size_t node_shift, const bool is_symmetric)
