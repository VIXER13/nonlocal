...
template<class T, class I, size_t DoF>
index_initializer<T, I, DoF>::index_initializer(finite_element_matrix<T, I>& matrix, const mesh::mesh_container_2d<T, I>& mesh, 
                                                const std::vector<bool>& is_inner, const size_t node_shift, const bool is_symmetric)
...
template<class T, class I, size_t DoF>
void index_initializer<T, I, DoF>::reset(const size_t node) {
...
template<class T, class I, size_t DoF>
void index_initializer<T, I, DoF>::run(const size_t row_glob, const size_t col_glob) {
...
template<class T, class I, size_t DoF>
void index_initializer<T, I, DoF>::operator()(const std::string&, const size_t e, const size_t i, const size_t j) {
    run(DoF * _mesh.node_number(e, i), DoF * _mesh.node_number(e, j));
}

template<class T, class I, size_t DoF>
void index_initializer<T, I, DoF>::operator()(const std::string&, const size_t eL, const size_t eNL, const size_t iL, const size_t jNL) {
