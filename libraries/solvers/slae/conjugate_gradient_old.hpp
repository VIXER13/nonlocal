...
class conjugate_gradient_old final {
...
public:
    explicit conjugate_gradient_old(const Eigen::SparseMatrix<T, Eigen::RowMajor, I>& A,
...
template<class T, class I>
conjugate_gradient_old<T, I>::conjugate_gradient_old(const Eigen::SparseMatrix<T, Eigen::RowMajor, I>& A,
                                                     const MPI_utils::MPI_ranges& ranges,
                                                     const conjugate_gradient_parameters<T> parameters)
    : _A{A}
...
template<class T, class I>
Eigen::Matrix<T, Eigen::Dynamic, 1> conjugate_gradient_old<T, I>::calc_b_full(const Eigen::Matrix<T, Eigen::Dynamic, 1>& b) const {
...
template<class T, class I>
void conjugate_gradient_old<T, I>::matrix_vector_product(Eigen::Matrix<T, Eigen::Dynamic, 1>& z, const Eigen::Matrix<T, Eigen::Dynamic, 1>& p) const {
...
template<class T, class I>
T conjugate_gradient_old<T, I>::tolerance() const {
    return _parameters.tolerance;
}

template<class T, class I>
uintmax_t conjugate_gradient_old<T, I>::max_iterations() const {
    return _parameters.max_iterations;
}

template<class T, class I>
T conjugate_gradient_old<T, I>::residual() const {
    return _curr_parameters.tolerance;
}

template<class T, class I>
uintmax_t conjugate_gradient_old<T, I>::iterations() const {
    return _curr_parameters.max_iterations;
}

template<class T, class I>
void conjugate_gradient_old<T, I>::set_tolerance(const T tolerance) {
    _parameters.tolerance = tolerance;
}

template<class T, class I>
void conjugate_gradient_old<T, I>::set_max_iterations(const uintmax_t max_iterations) {
