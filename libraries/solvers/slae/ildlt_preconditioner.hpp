...
class ildlt_preconditioner final : public preconditioner_base<T> {
    ...
    std::vector<std::vector<size_t>>
        _col_preds; // TODO: consider using metamath::linear::sparse_matrix_portrait for column predecessors
  ...
  public:
    ...
    explicit ildlt_preconditioner(metamath::linear::sparse_matrix<T, I, J>&& matrix) : _matrix{ std::move(matrix) } {
