...
template<size_t Dimension, class T, template<class, auto...> class Physical, auto... Args>
std::vector<model_parameters<Dimension, T>> get_models(
    const std::vector<equation_parameters<Dimension, T, Physical, Args...>>& parameters) {
...
template<size_t Dimension, class T, template<class, auto...> class Physical, auto... Args>
std::vector<Physical<T, Args...>> get_physical_parameters(
    const std::vector<equation_parameters<Dimension, T, Physical, Args...>>& parameters) {
...
template<size_t Dimension, class T, template<class, auto...> class Physical, auto... Args>
std::unordered_map<std::string, theory_t> theories_types(
    const std::unordered_map<std::string, equation_parameters<Dimension, T, Physical, Args...>>& parameters) {
