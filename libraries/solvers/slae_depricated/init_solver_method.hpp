...
std::unique_ptr<iterative_solver_base<T, I>> init_iterative_solver(const Eigen::SparseMatrix<T, Eigen::RowMajor, I>& matrix,
...
template<std::floating_point T, std::integral I>
std::unique_ptr<preconditioner_base<T, I>> init_preconditioner(const Eigen::SparseMatrix<T, Eigen::RowMajor, I>& matrix,
                                                               const bool is_symmetric) {
