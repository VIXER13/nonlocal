...
template<std::floating_point T, std::integral I>
mass_assembler_1d<T, I>::mass_assembler_1d(finite_element_matrix_1d<T, I>& matrix, const std::shared_ptr<mesh::mesh_1d<T>>& mesh,
...
template<std::floating_point T, std::integral I>
T mass_assembler_1d<T, I>::integrate_mass(const coefficient_t<T, 1>& density, const size_t e, const size_t i,
