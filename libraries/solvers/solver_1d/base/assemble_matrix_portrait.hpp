...
void init_shifts(Eigen::SparseMatrix<T, Eigen::RowMajor, I>& matrix, const mesh::mesh_1d<T>& mesh,
...
template<class T, class I>
void init_matrix_portrait(Eigen::SparseMatrix<T, Eigen::RowMajor, I>& matrix, const mesh::mesh_1d<T>& mesh,
                          const problem_settings& settings) {
