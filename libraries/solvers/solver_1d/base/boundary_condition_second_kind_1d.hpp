...
void boundary_condition_second_kind_1d(Vector& f, const boundary_condition_1d<T, Physics>& boundary_condition,
                                       const size_t index) {
...
template<class T, physics_t Physics, class Vector>
void boundary_condition_second_kind_1d(Vector& f, const boundaries_conditions_1d<T, Physics>& boundaries_conditions,
