...
template<>
std::vector<std::unique_ptr<element_2d_integrate_base<float>>> init_lagrangian_elements_2d() {
    return init<float>();
}
...
template<>
std::vector<std::unique_ptr<element_2d_integrate_base<long double>>> init_lagrangian_elements_2d() {
