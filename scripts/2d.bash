...
time make thermal_nonstationary_2d 
echo $line
...
time ./src/2d/thermal/thermal_nonstationary_2d $1 $3 $4 $5 $way_to_folder/$2/$file_name 
}
...
time ./src/2d/thermal/thermal_nonstationary_2d "D:/nonlocal/meshs/mesh_rectangular_2d.su2" 1 1 1 "D:/nonlocal/build/calculations/tests/test2d_nonlocal/" 